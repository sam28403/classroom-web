export function schema(mysql) {
  ...
  const statements = [
    ...
    `CREATE TABLE IF NOT EXISTS course_plans (teaching_class_id INTEGER PRIMARY KEY, english_name VARCHAR(100) NOT NULL, schedule TEXT NOT NULL, FOREIGN KEY(teaching_class_id) REFERENCES teaching_classes(id))`,
    `CREATE TABLE IF NOT EXISTS course_sessions (id ${id}, teaching_class_id INTEGER NOT NULL, start_at VARCHAR(30) NOT NULL, end_at VARCHAR(30) NOT NULL, location VARCHAR(100) NOT NULL, original_start VARCHAR(30) NOT NULL, change_reason VARCHAR(500), FOREIGN KEY(teaching_class_id) REFERENCES teaching_classes(id))`,
