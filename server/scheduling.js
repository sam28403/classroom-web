...
scheduling.post('/scheduled-courses', teacher, async (req, res) => {
...
scheduling.put('/scheduled-courses/:id', teacher, async (req, res) => {
  const data = validated(req.body)
...
scheduling.patch('/course-sessions/:id', teacher, async (req, res) => {
  let sessions
